/**
 * 이미지 메타데이터
 * @typedef {Object} AbImage.Metadata
...
/**
 * 이미지 데이터
 * @typedef {Object} AbImage.ImageInfo
...
/**
 * 섬네일 이미지 데이터
 * @typedef {Object} AbImage.ThumbnailInfo
 * @property {Boolean} loaded 로드 여부
 * @property {String} url 이미지 URL
 * @property {(Image|HTMLImageElement)} element 이미지 HTML 엘리먼트
 ...
 * @param {AbImage.Info} [options.info] 이미지 메타데이터
...
AbImage.prototype = {
	 ...
	 * 이미지를 로드합니다.
	 * @private
	 * @param {(AbImage.ImageInfo|AbImage.ThumbnailInfo)} imgdat 이미지 정보
